...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    func LongPressShowSpecialPrice(_SpecialPrice:Double,Currency:String) {
    ...
    /// - Note:
    /// Selection styles will only affect date selection. It is currently not possible to select multiple/range
    open var optionSelectionType: WWCalendarTimeSelectorSelection = .range
    ...
    ///
    /// `ExtraLight`
    open var optionStyleBlurEffect: UIBlurEffect.Style = .light
    ...
    // Fonts & Colors
    open var optionCalendarFontMonth = UIFont(name: APP_FONT_SEMIBOLD, size: 16)
    open var optionCalendarFontDays = UIFont(name: APP_FONT_MEDIUM, size: 12)
    open var optionCalendarFontToday = UIFont(name: APP_FONT_BOLD, size: 15)
    open var optionCalendarFontTodayHighlight = UIFont(name: APP_FONT_BOLD, size: 15)
    open var optionCalendarFontPastDates = UIFont(name: APP_FONT_MEDIUM, size: 15)
    open var optionCalendarFontPastDatesHighlight = UIFont(name: APP_FONT, size: 15)
    open var optionCalendarFontFutureDates = UIFont(name: APP_FONT, size: 15)
    open var optionCalendarFontFutureDatesHighlight = UIFont(name: APP_FONT, size: 15)
    
    open var optionCalendarFontColorMonth = UIColor(named: "Title_Header")
    open var optionCalendarFontColorDays = Theme.hostCalendarDay_Color
    open var optionCalendarFontColorToday = UIColor.darkGray
    open var optionCalendarFontColorTodayHighlight =  UIColor(named: "Title_Header")
    open var optionCalendarBackgroundColorTodayHighlight = Theme.PRIMARY_COLOR
    //open var optionCalendarBackgroundColorTodayHighlight = UIColor(named: "colorController")
    open var optionCalendarBackgroundColorTodayFlash = Theme.PRIMARY_COLOR
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor.white
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = Theme.PRIMARY_COLOR
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    
    open var optionCalendarFontCurrentYear = UIFont(name: APP_FONT_MEDIUM, size: 18)
    open var optionCalendarFontCurrentYearHighlight = UIFont(name: APP_FONT_MEDIUM, size: 20)
    open var optionCalendarFontColorCurrentYear = UIColor.darkGray
    open var optionCalendarFontColorCurrentYearHighlight =  UIColor(named: "Title_Header")
    open var optionCalendarFontPastYears = UIFont(name: APP_FONT_MEDIUM, size: 18)
    open var optionCalendarFontPastYearsHighlight = UIFont(name: APP_FONT_MEDIUM, size: 20)
    open var optionCalendarFontColorPastYears = UIColor.darkGray
    open var optionCalendarFontColorPastYearsHighlight =  UIColor(named: "Title_Header")
    open var optionCalendarFontFutureYears = UIFont(name: APP_FONT_MEDIUM, size: 18)
    open var optionCalendarFontFutureYearsHighlight = UIFont(name: APP_FONT_MEDIUM, size: 15)
    open var optionCalendarFontColorFutureYears = UIColor.darkGray
    open var optionCalendarFontColorFutureYearsHighlight =  UIColor(named: "Title_Header")
    
    open var optionClockFontAMPM = UIFont(name: APP_FONT, size: 15)
    open var optionClockFontAMPMHighlight = UIFont(name: APP_FONT, size: 15)
    open var optionClockFontColorAMPM =  UIColor(named: "Title_Header")
    open var optionClockFontColorAMPMHighlight = UIColor.white
    //open var optionClockBackgroundColorAMPMHighlight = UIColor.brown
    open var optionClockBackgroundColorAMPMHighlight = UIColor.white
    open var optionClockFontHour = UIFont(name: APP_FONT, size: 16)
    open var optionClockFontHourHighlight = UIFont(name: APP_FONT_MEDIUM, size: 18)
    open var optionClockFontColorHour =  UIColor(named: "Title_Header")
    open var optionClockFontColorHourHighlight = UIColor.white
    open var optionClockBackgroundColorHourHighlight = UIColor.white
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor.white
    open var optionClockFontMinute = UIFont(name: APP_FONT, size: 12)
    open var optionClockFontMinuteHighlight = UIFont(name: APP_FONT, size: 14)
    open var optionClockFontColorMinute =  UIColor(named: "Title_Header")
    open var optionClockFontColorMinuteHighlight = UIColor.white
    open var optionClockBackgroundColorMinuteHighlight = UIColor.white
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor.white
    open var optionClockBackgroundColorFace = UIColor(white: 0.9, alpha: 1)
    open var optionClockBackgroundColorCenter =  UIColor(named: "Title_Header")
    
    open var optionButtonTitleDone: String = "Done"
    open var optionButtonTitleCancel: String = "Cancel"
    open var optionButtonFontCancel = UIFont(name: APP_FONT, size: 16)
    open var optionButtonFontDone = UIFont(name: APP_FONT_MEDIUM, size: 16)
    open var optionButtonFontColorCancel = UIColor.white
    open var optionButtonFontColorDone = UIColor.white
    open var optionButtonFontColorCancelHighlight = UIColor.white.withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = UIColor.white.withAlphaComponent(0.25)
    open var optionButtonBackgroundColorCancel = UIColor.clear
    open var optionButtonBackgroundColorDone = UIColor.clear
    
    open var optionTopPanelBackgroundColor = UIColor.white
    open var optionTopPanelFont = UIFont(name: APP_FONT, size: 15)
    open var optionTopPanelFontColor = UIColor.white
    
    open var optionSelectorPanelFontMonth = UIFont(name: APP_FONT, size: 15)
    open var optionSelectorPanelFontDate = UIFont(name: APP_FONT, size: 15)
    open var optionSelectorPanelFontYear = UIFont(name: APP_FONT, size: 15)
    open var optionSelectorPanelFontTime = UIFont(name: APP_FONT, size: 15)
    open var optionSelectorPanelFontMultipleSelection = UIFont(name: APP_FONT, size: 15)
    open var optionSelectorPanelFontMultipleSelectionHighlight = UIFont(name: APP_FONT, size: 16)
    ...
    open var optionSelectorPanelBackgroundColor = UIColor.white.withAlphaComponent(0.9)
    
    open var optionMainPanelBackgroundColor = UIColor(named: "colorController")
    open var optionBottomPanelBackgroundColor = UIColor(named: "colorController")
    ...
    open var optionLayoutHeightRatio: CGFloat = 1.0
    
    /// If optionLayoutWidth is not defined, this ratio is used on the screen's width.
    open var optionLayoutWidthRatio: CGFloat = 1.0
    ...
    // Private Variables
    fileprivate let selAnimationDuration: TimeInterval = 0.0
    ...
    open override func viewDidLoad() {
        super.viewDidLoad()
        clockView.backgroundColor = UIColor(named: "colorController")
        yearTable.backgroundColor = UIColor(named: "colorController")
        calendarTable.backgroundColor = UIColor(named: "colorController")
        
        self.view.backgroundColor = UIColor(named: "colorController")
        
        monthsView.backgroundColor = UIColor(named: "colorController")
        
        backgroundContentView.backgroundColor = UIColor(named: "colorController")
        topContainerView.backgroundColor = UIColor(named: "colorController")
        bottomContainerView.backgroundColor = UIColor(named: "colorController")
        
        
        backgroundDayView.backgroundColor =  UIColor(named: "colorController")
        backgroundSelView.backgroundColor =  UIColor(named: "colorController")
         backgroundRangeView.backgroundColor =  UIColor(named: "colorController")
        backgroundContentView.backgroundColor =  UIColor(named: "colorController")
         backgroundButtonsView.backgroundColor =  UIColor(named: "colorController")
...
//        background.backgroundColor = UIColor(named: "colorController")
...
//        clockView.backgroundColorMinuteHighlightNeedle = optionClockBackgroundColorMinuteHighlightNeedle
    ...
    @IBAction func selectEndRange() {
        if isSelectingStartRange == false {
            ...
            flashDate = date
            calendarTable.reloadData()
            calendarTable.scrollToRow(at: IndexPath(row: 4, section: 0), at: UITableView.ScrollPosition.top, animated: false)
        }
        else {
    ...
    fileprivate func showYear(_ userTap: Bool) {
        ...
        if userTap {
            yearRow1 = optionCurrentDate.year - 5
            yearTable.reloadData()
            yearTable.scrollToRow(at: IndexPath(row: 3, section: 0), at: UITableView.ScrollPosition.top, animated: false)
        }
        else {
            yearTable.reloadData()
        }
    ...
    fileprivate func updateDate() {
        ...
        if(!Utility.shared.isfrom_availability_calendar_date)
        {
        Utility.shared.calendar_Date_Array = optionCurrentDateRange.array
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == calendarTable {
            if let c = tableView.dequeueReusableCell(withIdentifier: "cell") {
                ...
                calRow.dateTodayFontColor = optionCalendarFontColorFutureDates
                calRow.dateTodayHighlightFontColor = optionCalendarBackgroundColorFutureDatesHighlight
                ...
                calRow.dateFutureFontColor =  UIColor(named: "Title_Header")
                //= optionCalendarFontColorFutureDates
                ...
                calRow.blockedDateFont = optionCalendarFontToday
                calRow.blockedDateFontHighlight = optionCalendarFontTodayHighlight
                calRow.blockedDateFontColor = optionCalendarFontColorToday
                calRow.blockedDateHighlightFontColor = optionCalendarFontColorTodayHighlight
                calRow.blockedDateHighlightBackgroundColor = optionCalendarBackgroundColorTodayHighlight
                calRow.blockedDateFlashBackgroundColor = optionCalendarBackgroundColorTodayFlash
    ...
    open func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView == yearTable {
            ...
            if delegate?.WWCalendarTimeSelectorShouldSelectDate?(self, date: newDate!) ?? true {
                ...
                Utility.shared.isfrom_availability_calendar_date = false
                updateDate()
        ...
        if delegate?.WWCalendarTimeSelectorShouldSelectDate?(self, date: date) ?? true {
            ...
            case .multiple:
                ...
                if let indexToDelete = multipleDates.index(of: date) {
                    ...
                    selMultipleDatesTable.scrollToRow(at: indexPath, at: UITableView.ScrollPosition.middle, animated: false)
...
//                        shouldResetRange = true
                        let date1: Date = rangeDate
                        let date2: Date = optionCurrentDateRange.start
                        optionCurrentDateRange.setStartDate(min(date1, date2))
                        optionCurrentDateRange.setEndDate(max(date1, date2))
                        shouldResetRange = true
                    }
                }
...
internal class WWCalendarRow: UIView {
    ...
    internal var blockedDateFont:UIFont!
    internal var blockedDateFontHighlight:UIFont!
    internal var blockedDateFontColor:UIColor!
    internal var blockedDateHighlightFontColor: UIColor!
    internal var blockedDateHighlightBackgroundColor: UIColor!
    internal var blockedDateFlashBackgroundColor: UIColor!
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        monthParagraph.alignment = Utility.shared.isRTLLanguage() ? NSTextAlignment.right : NSTextAlignment.left
        ...
        if detail.type == .month {
            ...
            let str = NSAttributedString(string: monthName, attributes: [NSAttributedString.Key.font: monthFont, NSAttributedString.Key.foregroundColor: monthFontColor, NSAttributedString.Key.paragraphStyle: monthParagraph])
            str.draw(in: CGRect(x: 20, y: boxHeight - monthHeight, width: rect.width-40, height: monthHeight))
        }
            ...
            for (index, element) in days.enumerated() {
                let str = NSAttributedString(string: element, attributes: [NSAttributedString.Key.font: dayFont, NSAttributedString.Key.foregroundColor:  UIColor(named: "Title_Header"), NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            for i in 1...7 {
                if date.weekday == i {
                    ...
                    let white_Color = UIColor.white.cgColor
                     ...
                     if date == today {
                        ...
                        fontHighlightColor = dateTodayHighlightFontColor
                         backgroundHighlightColor = Theme.PRIMARY_COLOR.cgColor
                    }
                     ...
                     if(Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)))
                    {
                        //font = comparisonDates.contains(date) ? dateTodayFontHighlight : dateTodayFont
                        font = Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)) ? blockedDateFontHighlight : blockedDateFont
                        fontColor = UIColor.white
                        fontHighlightColor = UIColor.white
                      //  backgroundHighlightColor = Theme.Red_color.cgColor
                    }
                    else if(Utility.shared.host_specialPricing_Array.contains(fmt.string(from: date)))
                     {
                        font = Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)) ? blockedDateFontHighlight : blockedDateFont
                        fontColor = UIColor.white
                        fontHighlightColor = UIColor.white
                       // backgroundHighlightColor = UIColor.green.cgColor
                    }
                     else if(Utility.shared.host_bookedPricing_Array.contains(fmt.string(from: date)))
                     {
                        font = Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)) ? blockedDateFontHighlight : blockedDateFont
                        fontColor = blockedDateFontColor
                        fontHighlightColor = Theme.BOOKING_PRICING_COLOR
                        backgroundHighlightColor = blockedDateHighlightBackgroundColor.cgColor
                    }
                    ...
                    let sampleDateArray = NSMutableArray()
                    sampleDateArray.removeAllObjects()
                    ...
                    if Utility.shared.calendar_Date_Array.count == 0{
                        ...
                        for i in Utility.shared.calendar_Date_Array{
                            
                            //sampleDateArray.removeAllObjects()
                            sampleDateArray.addObjects(from: [fmt.string(from: i) as Any])
                        }
                    }
                    
                    
                    if fmt.string(from: date) == fmt.string(from: today) {
                        
                        if(Utility.shared.host_specialPricing_Array.contains(fmt.string(from: today)))
                        {
                            
                            
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.SPECIAL_PRICING_COLOR,NSAttributedString.Key.underlineColor:Theme.SPECIAL_PRICING_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                            str.addAttribute(NSAttributedString.Key.underlineStyle , value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0,str.length))
                            
                        }
                        if(Utility.shared.host_blockedDates_Array.contains(fmt.string(from: today)))
                        {
                           
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:Theme.Red_color,NSAttributedString.Key.foregroundColor:Theme.Red_color,NSAttributedString.Key.underlineColor:Theme.Red_color,NSAttributedString.Key.paragraphStyle: paragraph])
                            str.addAttribute(NSAttributedString.Key.underlineStyle , value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0,str.length))
                            
                        }
                        if(Utility.shared.host_bookedPricing_Array.contains(fmt.string(from: today)))
                        {
                            
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.BOOKING_PRICING_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                            str.addAttribute(NSAttributedString.Key.strikethroughStyle, value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0,str.length))
                        }
                        else
                        {
               
                            
                            if sampleDateArray.count == 0{
                                Utility.shared.isTodayEnable = false
                            }
                            
                            if (date == today) && Utility.shared.isTodayEnable == true && sampleDateArray.contains(fmt.string(from: today)){
                                
                                //   dateTodayHighlightFontColor = UIColor.red
                                
                                
                                if Utility.shared.calendar_Date_Array.count > 0{
                                    
                                    if  Utility.shared.calendar_Date_Array.count > 0 && sampleDateArray.contains(fmt.string(from: today)){
                                        ...
                                        if Utility.shared.calendar_Date_Array.count == 0{
                                            ...
                                            if Utility.shared.isTodayEnable == true  {
                                                
                                                ctx?.setFillColor(Theme.PRIMARY_COLOR.cgColor)
                                            ...
                                            if multipleSelectionEnabled {
                                                var testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: dateFutureFontHighlight, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                                        ...
                                        //   str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize:15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:UIColor.darkGray,NSAttributedString.Key.paragraphStyle: paragraph])
                                ...
                                if Utility.shared.isTodayEnable == true{
                                    ...
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:UIColor.white,NSAttributedString.Key.paragraphStyle: paragraph])
                                }else {
                                    
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:UIColor.darkText,NSAttributedString.Key.paragraphStyle: paragraph])
                                }
                                ...
                                if Utility.shared.host_blockedDates_Array.contains(fmt.string(from: today)){
                                    ...
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.Red_color,NSAttributedString.Key.underlineColor:Theme.Red_color,NSAttributedString.Key.paragraphStyle: paragraph])
                                    str.addAttribute(NSAttributedString.Key.underlineStyle, value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0, str.length))
                                    
                                  
                                }else if Utility.shared.host_bookedPricing_Array.contains(fmt.string(from: today)){
                                    
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.BOOKING_PRICING_COLOR,NSAttributedString.Key.paragraphStyle: paragraph])
                                    str.addAttribute(NSAttributedString.Key.strikethroughStyle, value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0, str.length))
                                 
                                }else if Utility.shared.host_specialPricing_Array.contains(fmt.string(from: today)){
                                    ...
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:UIColor(named: "Title_Header"),NSAttributedString.Key.paragraphStyle: paragraph])
                                    //str.addAttribute(NSAttributedString.Key.strikethroughStyle, value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0, str.length))
                    ...
                    else if comparisonDates.contains(date) {
                        Utility.shared.isTodayEnable = false
                        if(Utility.shared.calendar_Date_Array.count > 0)
                        {
...
//                                {
                        ...
                        else
                        {
                            ...
                            {
                        str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: font!, NSAttributedString.Key.foregroundColor:UIColor.darkGray, NSAttributedString.Key.paragraphStyle: paragraph])
                            }
                        }
                    }
                    
                        //MARK: - BLOCKED DATES CONDITION
                    else if(Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)))
                    {
                        ...
                        str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.Red_color,NSAttributedString.Key.underlineColor:Theme.Red_color,NSAttributedString.Key.paragraphStyle: paragraph])
                            ...
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: font!, NSAttributedString.Key.foregroundColor: UIColor.lightGray, NSAttributedString.Key.paragraphStyle: paragraph])
                    ...
                    {
//                        ctx?.setFillColor(BOOKING_PRICING_COLOR.cgColor)
//                        let size = min(boxHeight, boxWidth)-10
//                        let x = CGFloat(i - 1) * boxWidth + (boxWidth - size) / 2
//                        let y = (boxHeight - size) / 2
//                        ctx?.fillEllipse(in: CGRect(x: x, y: y, width: size, height: size))
                        str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: APP_FONT_MEDIUM, size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:Theme.BOOKING_PRICING_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                        ...
                        if(date == today)
                        {
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: font!, NSAttributedString.Key.foregroundColor: UIColor(named: "Title_Header"), NSAttributedString.Key.paragraphStyle: paragraph])
                        }
                        else
                        {
...
//                if(Utility.shared.host_specialPricing_Array.contains(fmt.string(from:dateTapped)))
//                {
//                 for index in Utility.shared.host_specialPrice_Array
//                 {
//                 if(index["Date"] as! String == (fmt.string(from:dateTapped)))
//                 {
//                    let Special_Price = index["SpecialPrice"]!
//                    let currency = index["Currency"]
//                    delegate.LongPressShowSpecialPrice(_SpecialPrice:Special_Price as! Double,Currency:currency as! String)
//                  }
//
//
//                }
...
//                else
//                {
                    self.delegate.WWCalendarRowDidSelect(dateTapped)
            ...
            for i in 1...7 {
                if date.weekday == i {
                    if date == flashDate {
                        ...
                        if flashDate == today {
                            flashColor =  UIColor(named: "Title_Header")
                        }
                        else if(Utility.shared.host_blockedDates_Array.contains(fmt.string(from: flashDate)))
                        {
                            //font = comparisonDates.contains(date) ? dateTodayFontHighlight : dateTodayFont
